...
<div class="d-flex" style="min-height: 100vh;">
    ...
    <div id="sidebar" class="sidebar position-fixed d-flex flex-column align-items-start p-4">
        <img src="<?php echo e(asset('images/logoumkm.png')); ?>" alt="UMKMGO" style="width: 120px;" class="mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aplikasi\Xampp\htdocs\umkmgo_kel2-yuda_umkgo\umkmgo\resources\views/user/dashboard.blade.php ENDPATH**/ ?>