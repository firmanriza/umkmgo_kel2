...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <a href="{{ url()->previous() }}" class="inline-block mb-6">
            <button class="px-4 py-2 bg-blue-100 text-blue-600 rounded-md hover:bg-blue-200 transition-colors">
                ← Back
            </button>
        </a>
        ...
        <div class="flex justify-between items-center">
            <button onclick="history.back()" class="px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors">
                Return to attempt
            </button>
            <form action="{{ route('quiz.final_submit', $quiz->id) }}" method="POST" class="inline">
                @csrf
    ...
    <div class="fixed top-4 right-4 bg-white rounded-lg shadow-lg p-4 w-64">
