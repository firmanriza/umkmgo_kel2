...
<div class="d-flex min-vh-100" style="width: 100vw;">
    ...
    <div class="bg-white d-flex flex-column justify-content-center p-5" style="width: 100vw; max-width: 50vw;">
        ...
        <div class="text-center mt-3">
            Already have an account? <a href="<?php echo e(route('login')); ?>" class="fw-semibold text-decoration-none text-primary">LOGIN HERE</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aplikasi\Xampp\htdocs\umkmgo_kel2-yuda_umkgo\umkmgo\resources\views/auth/register.blade.php ENDPATH**/ ?>